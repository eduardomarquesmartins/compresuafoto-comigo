...
export default function AdminOrdersPage() {
    ...
    const approvedCount = orders.filter(o => o.status === "approved" || o.status === "PAID").length;
        ...
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex gap-4">
                    <div className="bg-yellow-500/10 border border-yellow-500/30 px-5 py-3 rounded-2xl text-center">
                        <p className="text-2xl font-black text-yellow-500">{pendingCount}</p>
                        <p className="text-[9px] font-bold uppercase tracking-widest text-yellow-500/70">Pendentes</p>
                    </div>
                    <div className="bg-green-500/10 border border-green-500/30 px-5 py-3 rounded-2xl text-center">
                        <p className="text-2xl font-black text-green-500">{approvedCount}</p>
                        <p className="text-[9px] font-bold uppercase tracking-widest text-green-500/70">Aprovados</p>
                    </div>
                </div>
            </div>
