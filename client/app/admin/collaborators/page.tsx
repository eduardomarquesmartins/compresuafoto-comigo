...
export default function CollaboratorsPage() {
  ...
  const [closingForm, setClosingForm] = useState({ serviceId: "", quantity: "1", notes: "", additionalClauses: "" });
  ...
  const generateContract = async () => {
    ...
    try {
      const response = await api.post("/collaborators/admin/monthly-contract", { collaboratorId: selectedId, competence, additionalClauses: closingForm.additionalClauses }, { responseType: "blob" });
